...
if (isset($_POST['save'])) {
    ...
    if (!empty($fname) || !empty($lname) || !empty($username) || !empty($role)){
      header('location:'.BASE_URL.'admin_dashboard/users.php?error=1');
      exit;
    }
    $response = $user->save($fname, $lname, $username, $password, $role);

    if($response){
      header('location:'.BASE_URL.'admin_dashboard/users.php?success=1');
      exit;
    }
    else
    {
...
<li class="nav-item d-none d-sm-inline-block">
  ...
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    <li class="nav-item menu-open">
      <a href="<?php echo BASE_URL;?>admin_dashboard/" class="nav-link <?php echo ($current_page == 'index.php') ? 'active' : ''; ?>">
        <i class="nav-icon fas fa-tachometer-alt"></i>
        <p>DASHBOARD</p>
      </a>
    <li class="nav-item menu-open">
      <a href="<?php echo BASE_URL;?>admin_dashboard/users.php" class="nav-link <?php echo ($current_page == 'users.php'|| $current_page == 'user_register.php') ? 'active' : ''; ?>">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="<?php echo BASE_URL;?>admin_dashboard/user_register.php" class="nav-link <?php echo ($current_page == 'user_register.php') ? 'active' : ''; ?>">
            <i class="nav-icon fas fa-plus"></i>
            <p>ADD NEW USER</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo BASE_URL;?>admin_dashboard/users.php" class="nav-link <?php echo ($current_page == 'users.php') ? 'active' : ''; ?>">
    ...
    <li class="nav-item menu-open">
      <a href="<?php echo BASE_URL;?>admin_dashboard/category.php" class="nav-link <?php echo ($current_page == 'category.php' || $current_page == 'view_category.php') ? 'active' : ''; ?>">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="<?php echo BASE_URL;?>admin_dashboard/category.php" class="nav-link <?php echo ($current_page == 'category.php') ? 'active' : ''; ?>">
            <i class="nav-icon fas fa-plus"></i>
            <p>ADD CATEGORY</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo BASE_URL;?>admin_dashboard/view_category.php" class="nav-link <?php echo ($current_page == 'view_category.php') ? 'active' : ''; ?>">
            <i class="nav-icon fas fa-bars"></i>
            <p>MANAGE CATEGORY</p>
          </a>
        </li>
